...
WANDB_LOG = True
NUM_EPOCH = 10
MODEL_PATH = "/root/llm_post_train/qwen/data/data/Qwen2.5-0.5B"
REWARD_PATH = "/root/llm_post_train/qwen/data/results/rm/final_model"
OUTPUT_PATH = "/root/llm_post_train/qwen/data/results/ppo"
TMP_PATH = "/hy-tmp/qwen"
SEED = 42
MAX_LENGTH = 512
...
data_files = find_files(["rl"],"/root/llm_post_train/qwen/data/reward/data")
