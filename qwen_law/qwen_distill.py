...
WANDB_LOG = True
TMP_PATH = "/root/llm_post_train/qwen"

output_path = "/root/llm_post_train/qwen/results/distill"
model_path = "/root/llm_post_train/qwen/data/Qwen2.5-0.5B"
teacher_model_path = "/root/llm_post_train/qwen/data/Qwen2.5-0.5B"
